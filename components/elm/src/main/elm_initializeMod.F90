...
contains
  ...
  subroutine initialize1( )
    ...
    use decompInitMod             , only: decompInit_lnd, decompInit_user_defined_decomposition, decompInit_clumps, decompInit_gtlcp
    ...
    case ("round_robin")
       ...
       deallocate(amask)
    case ("data_driven_partitioning")
       call decompInit_user_defined_decomposition(ni, nj, amask)
       deallocate(amask)
